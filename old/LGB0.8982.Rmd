...
train <- data.frame(tr, tr_aec, tr_umap, tr_sin, tr_dn_aec)
test <- data.frame(te, te_aec, te_umap, te_sin, te_dn_aec)

rm(tr, tr_aec, tr_umap, tr_sin, tr_dn_aec, 
   te, te_aec, te_umap, te_dn_aec)
gc();gc()
```
