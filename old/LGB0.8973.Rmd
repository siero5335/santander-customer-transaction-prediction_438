...
train <- data.frame(tr, tr_tr, tr_aec, tr_umap, tr_dn_aec, tr_knn, tr_digit0, tr_digit1, tr_3q, tr_4q, tr_std, tr_cumsum, tr_sin, tr_tan, tr_sinh)
test <- data.frame(te, te_tr, te_aec, te_umap, te_dn_aec, te_knn, te_digit0, te_digit1, te_3q, te_4q, te_std, te_cumsum, te_sin, te_tan, te_sinh)

train$f_var_68 <- NULL
test$f_var_68 <- NULL

rm(tr, tr_tr, tr_aec, tr_umap, tr_dn_aec, tr_knn, dn_aec, tr_digit0, tr_digit1, tr_3q, tr_4q, tr_std, tr_cumsum, tr_sin, tr_tan, tr_sinh,
   te, te_tr, te_aec, te_umap, te_dn_aec, te_knn, te_digit0, te_digit1, te_3q, te_4q, te_std, te_cumsum, te_sin, te_tan, te_sinh)
gc();gc()
```
