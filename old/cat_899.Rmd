...
tr_2q <- (tr[, c('var_81', 'var_139', 'var_12', 'var_53', 'var_6', 'var_110', 'var_146', 'var_26', 'var_174', 'var_76', 'var_22')])^2
te_2q <- (te[, c('var_81', 'var_139', 'var_12', 'var_53', 'var_6', 'var_110', 'var_146', 'var_26', 'var_174', 'var_76', 'var_22')])^2

tr_3q <- (tr[, c('var_81', 'var_139', 'var_12', 'var_53', 'var_6', 'var_110', 'var_146', 'var_26', 'var_174', 'var_76', 'var_22')])^3
te_3q <- (te[, c('var_81', 'var_139', 'var_12', 'var_53', 'var_6', 'var_110', 'var_146', 'var_26', 'var_174', 'var_76', 'var_22')])^3

tr_4q <- (tr[, c('var_81', 'var_139', 'var_12', 'var_53', 'var_6', 'var_110', 'var_146', 'var_26', 'var_174', 'var_76', 'var_22')])^4
te_4q <- (te[, c('var_81', 'var_139', 'var_12', 'var_53', 'var_6', 'var_110', 'var_146', 'var_26', 'var_174', 'var_76', 'var_22')])^4
...
train <- data.frame(tr, tr_aec, tr_umap, tr_digit0, tr_digit1, tr_digit2, tr_2q, tr_3q, tr_4q, tr_cumsum, tr_sin)
test <- data.frame(te, te_aec, te_umap, te_digit0, te_digit1, te_digit2, te_2q, te_3q, te_4q, te_cumsum, te_sin)

train$f_var_68 <- NULL
test$f_var_68 <- NULL

rm(tr, tr_aec, tr_umap, tr_digit0, tr_digit1, tr_digit2, tr_2q, tr_3q, tr_4q, tr_cumsum, tr_sin, 
   te, te_aec, te_umap, te_digit0, te_digit1, te_digit2, te_2q, te_3q, te_4q, te_cumsum, te_sin)
gc();gc()
```
