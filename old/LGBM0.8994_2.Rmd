...
train <- data.frame(tr, tr_aec, tr_umap, tr_sin, tr_knn)
test <- data.frame(te, te_aec, te_umap, te_sin, te_knn)

rm(tr, tr_aec, tr_umap, tr_sin, tr_knn, 
   te, te_aec, te_umap, te_knn)
gc();gc()
```
