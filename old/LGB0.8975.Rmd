...
tr_digit0 <- fread("train_test_round/train_round0.csv", header = T, showProgress = F)
te_digit0 <- fread("train_test_round/test_round0.csv", header = T, showProgress = F)
tr_digit1 <- fread("train_test_round/train_round1.csv", header = T, showProgress = F)
te_digit1 <- fread("train_test_round/test_round1.csv", header = T, showProgress = F)
...
train <- data.frame(tr, tr_tr, tr_aec, tr_umap, tr_dn_aec, tr_knn, tr_digit0, tr_digit1, tr_OHE)
test <- data.frame(te, te_tr, te_aec, te_umap, te_dn_aec, te_knn, te_digit0, te_digit1, te_OHE)

train$f_var_68 <- NULL
test$f_var_68 <- NULL

rm(tr, tr_tr, tr_aec, tr_umap, tr_dn_aec, tr_knn, dn_aec, tr_digit0, tr_digit1, tr_OHE,
   te, te_tr, te_aec, te_umap, te_dn_aec, te_knn, te_digit0, te_digit1, te_OHE)
gc();gc()
```
